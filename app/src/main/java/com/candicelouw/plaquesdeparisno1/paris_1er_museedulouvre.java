 ...
 */
public class paris_1er_museedulouvre extends AppWidgetProvider {
    public void onReceive(Context context, Intent intent)
    {
        ...
        {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.paris_1er_museedulouvre);
